...
inline fun <reified T : AndroidComponentsExtension<out CommonExtension<*, *, *, *>, out VariantBuilder, out Variant>> Project.getAndroidComponents() = extensions.getByType(AndroidComponentsExtension::class.java) as T
