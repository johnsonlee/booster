 ...
 * @author johnsonlee
 */
abstract class DotGraph(val dir: String) : CallGraphRenderer

sealed class Digraph(dir: String) : DotGraph(dir) {

    object LR : Digraph("LR")

    object TB : Digraph("TB")
